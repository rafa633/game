...
// 🧮 Geração de multiplicações simples
function gerarFasesMultiplicacao(qtd) {
  const fases = [];
  for (let i = 0; i < qtd; i++) {
...
// 🎯 Variáveis do jogo
const todasAsFases = gerarFasesMultiplicacao(10);
let faseAtual = 0;
let acertos = 0;
...
function mostrarFinal() {
  ...
  btnReiniciar.onclick = () => {
    const novasFases = gerarFasesMultiplicacao(10);
