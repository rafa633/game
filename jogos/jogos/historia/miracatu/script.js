...
curiosidade.innerHTML = `
  • MIRACATU SIGNIFICA “TERRA DE GENTE BOA” NA LÍNGUA INDÍGENA!<br>
  • O FUNDADOR DE MIRACATU FOI PIERRE LARAGNOIT, UM IMIGRANTE FRANCÊS! 🇫🇷<br>
  • EM 1938, MIRACATU FOI EMANCIPADA DO MUNICÍPIO DE IGUAPE!<br>
  • FOI FUNDADA COMO “PRAINHA” EM 1872 E RENOMEADA EM 1944.<br>
  • A ESTRADA DE FERRO SOROCABANA CHEGOU EM 1914, IMPULSIONANDO O COMÉRCIO!<br>
  • A FRUTA MAIS PRODUZIDA EM MIRACATU É A BANANA! 🍌<br>
  • IMIGRANTES JAPONESES AJUDARAM A TORNAR MIRACATU UM CENTRO EXPORTADOR DE BANANAS! 🍌<br><br>
...
const perguntas = [
  {
    pergunta: "QUAL É O SIGNIFICADO DO NOME MIRACATU?",
    opcoes: ["TERRA DE GENTE BOA", "TERRA DAS ÁGUAS", "CIDADE DAS BANANAS", "MATA VERDE"],
    correta: "GENTE BOA"
  },
  {
    pergunta: "Quando Miracatu foi emancipado de Iguape?",
    opcoes: ["1500", "1938", "1998", "1800"],
    correta: "1938"
  },
  {
    pergunta: "QUAL FRUTA MAIS PRODUZIDA EM MIRACATU?",
    opcoes: ["MAÇÃ", "UVA", "BANANA", "MANGA"],
    correta: "BANANA"
  },
  {
    pergunta: "QUAL O ANTIGO NOME DE MIRACATU?",
    opcoes: ["JUQUIA", "RIBEIRINHO", "PRAINHA", "IGUAPE"],
    correta: "PRAINHA"
  },
  {
    pergunta: "QUEM FOI O FUNDADOR DE MIRACATU?",
    opcoes: ["PEDRO ALVARES", "José Antônio da Silva", "PAULO LARAGNOIT", "PIERRE LARAGNOIT"],
    correta: "PIERRE LARAGNOIT"
  }
];
