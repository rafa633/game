...
curiosidade.innerHTML = `
  ...
  • A CIDADE FICA NO VALE DO RIBEIRA, EM SÃO PAULO.<br>
  • FOI FUNDADA COMO “PRAINHA” E RENOMEADA EM 1944.<br>
  • É UM DOS MAIORES PRODUTORES DE BANANA DO BRASIL! 🍌<br>
  • POSSUI A MAIOR RESERVA PRIVADA DE MATA ATLÂNTICA: LEGADO DAS ÁGUAS! 🌳<br><br>
...
const perguntas = [
  {
    ...
    correta: "TERRA DE GENTE BOA"
  },
  {
    pergunta: "QUAL ERA O NOME ANTIGO DE MIRACATU?",
    opcoes: ["JUQUIÁ", "PRAINHA", "PEDRO DE TOLEDO", "SÃO LOURENÇO"],
    correta: "PRAINHA"
  },
  {
    pergunta: "QUAL FRUTA É MUITO PRODUZIDA EM MIRACATU?",
    opcoes: ["MAÇÃ", "UVA", "BANANA", "MANGA"],
    correta: "BANANA"
  },
  {
    pergunta: "QUAL RESERVA FICA EM MIRACATU?",
    opcoes: ["PARQUE DO IBIRAPUERA", "LEGADO DAS ÁGUAS", "SERRA DA CANTAREIRA", "PARQUE DAS EMOÇÕES"],
    correta: "LEGADO DAS ÁGUAS"
  },
  {
    pergunta: "EM QUE ESTADO FICA MIRACATU?",
    opcoes: ["MINAS GERAIS", "PARANÁ", "SÃO PAULO", "RIO DE JANEIRO"],
    correta: "SÃO PAULO"
  }
];
